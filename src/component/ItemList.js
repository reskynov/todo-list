...
function ItemList() {
  ...
  function getItemDetail(){
    axios.get(base_url +"activity-groups/"+id)
  ...
  function addItemTodo(){
    axios.post(base_url + 'todo-items', {
  ...
  function deleteItemTodo(){
    axios.delete(base_url +'todo-items/'+selectedItem.id)
    .then(function (){
      getItemDetail()
    }).catch(function (error){
      console.log(error)
  ...
  function updateItemTodo(sele){
    axios.patch(base_url +'todo-items/'+selectedItem.id, {
      title: newTodo.newTitle,
      priority: newTodo.newPriority
    })
    .then(function (){
  ...
  function updateTitleActivity(){
    axios.patch(base_url + 'activity-groups/'+id, {
      title: titleActivity
    })
    .then(function (){
      getItemDetail()
  ...
  function handleCheckBox(id){
     ...
     axios.patch(base_url +'todo-items/'+id, {
